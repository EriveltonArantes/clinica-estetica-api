...
|----------|---------|---------|
| `/api/profissionals` | GET / POST / PUT / DELETE | CRUD de Profissional |
| `/api/procedimentos` | GET / POST / PUT / DELETE | CRUD de Procedimento |
| `/api/agendamentos` | GET / POST / PUT / DELETE | CRUD de Agendamento |
| `/api/pacotes` | GET / POST / PUT / DELETE | CRUD de Pacote |
